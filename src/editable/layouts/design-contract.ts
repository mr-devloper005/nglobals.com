...
export const editableRootStyle = {
  ...
  '--editable-reading-width': '760px',
  '--slot4-page-bg': '#f6f3ee',
  '--slot4-page-text': '#11131c',
  '--slot4-panel-bg': '#ffffff',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#4f5565',
  '--slot4-soft-muted-text': '#687083',
  '--slot4-accent': '#c6a063',
  '--slot4-accent-fill': '#c6a063',
  '--slot4-accent-soft': '#f6ecd9',
  '--slot4-dark-bg': '#171922',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#ece7de',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#f6f3ee',
  '--slot4-lavender': '#171922',
  '--slot4-gray': '#f2f2f4',
  '--slot4-body-gradient': 'linear-gradient(180deg, #ffffff 0%, #f6f3ee 44%, #f2f2f4 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  ...
  type: {
    ...
    heroTitle: 'text-4xl font-extrabold leading-[1.08] tracking-tight sm:text-5xl lg:text-[3.75rem]',
