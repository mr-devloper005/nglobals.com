...
const inputClass = 'h-12 rounded-2xl border border-[var(--editable-border)] bg-white px-4 text-base font-bold text-[#11131c] outline-none transition placeholder:text-[#6b7280] focus:border-[#c6a063] focus:bg-white'
