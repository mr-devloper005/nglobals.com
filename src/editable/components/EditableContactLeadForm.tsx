...
export function EditableContactLeadForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-[2rem] border border-[var(--editable-border)] bg-white p-6 text-[#11131c] shadow-2xl shadow-black/5 backdrop-blur md:p-8">
      ...
      <button type="submit" disabled={status === 'submitting'} className="mt-6 inline-flex h-12 w-full items-center justify-center gap-2 rounded-2xl bg-[#171922] px-6 text-sm font-black uppercase tracking-[0.24em] text-white shadow-lg transition hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-70">
